...
int main()
{
    ...
    Jogador jogador = {0};
    jogador.posicao = (Vector2){0, 80}; //Posição Inicial
    ...
    while (!WindowShouldClose())
    {
        ...
        Texture2D cenario_fundo = LoadTexture("cenario/banco_bananalto.jpg.png");
        ...
        DrawTextureRec(verde1, cenarioTeste[1].retangulo, (Vector2){0, 450}, RAYWHITE);
        Texture2D marrom1 = LoadTexture("cenario/chao_mario.png");
        DrawTextureRec(marrom1, cenarioTeste[2].retangulo, (Vector2){1900, 450}, RAYWHITE);
        Texture2D azul1 = LoadTexture("cenario/chao_mario.png");
        DrawTextureRec(azul1, cenarioTeste[3].retangulo, (Vector2){0, 150}, RAYWHITE);
        Texture2D amarelo1 = LoadTexture("cenario/chao_mario.png");
        DrawTextureRec(amarelo1, cenarioTeste[4].retangulo, (Vector2){1300, 450}, RAYWHITE);
        Texture2D preto1 = LoadTexture("cenario/bloco_mario.png");
        DrawTextureRec(preto1, cenarioTeste[5].retangulo, (Vector2){1310, 210}, RAYWHITE);
        Texture2D cinza1 = LoadTexture("cenario/chao_mario.png");
        DrawTextureRec(cinza1, cenarioTeste[6].retangulo, (Vector2){1600, 550}, RAYWHITE);

        //parte 2
        Texture2D vermelho2 = LoadTexture("cenario/chao_mario.png");
        DrawTextureRec(vermelho2, cenarioTeste[7].retangulo, (Vector2){4670, 350}, RAYWHITE);
        Texture2D roxo2 = LoadTexture("cenario/chao_mario.png");
        DrawTextureRec(roxo2, cenarioTeste[8].retangulo, (Vector2){4650, 70}, RAYWHITE);
        Texture2D preto2 = LoadTexture("cenario/bloco_mario.png");
        DrawTextureRec(preto2, cenarioTeste[9].retangulo, (Vector2){4720, 70}, RAYWHITE);
        Texture2D azul2 = LoadTexture("cenario/chao_mario.png");
        DrawTextureRec(azul2, cenarioTeste[10].retangulo, (Vector2){3950, 610}, RAYWHITE);
        Texture2D cinza2 = LoadTexture("cenario/chao_mario.png");
        DrawTextureRec(cinza2, cenarioTeste[11].retangulo, (Vector2){4300, 540}, RAYWHITE);
        Texture2D verde2 = LoadTexture("cenario/chao_mario.png");
        DrawTextureRec(verde2, cenarioTeste[12].retangulo, (Vector2){4400, 470}, RAYWHITE);
        Texture2D laranja2 = LoadTexture("cenario/bandeira.png");
        DrawTextureRec(laranja2, cenarioTeste[13].retangulo, (Vector2){5950, 350}, RAYWHITE);
